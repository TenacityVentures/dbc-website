  ...
  return (
    <div>
      ...
      <div className="mt-8 grid gap-5 sm:grid-cols-2">
        ...
        >
          <h2 className="text-[17px] font-medium text-ink">Site content</h2>
          <p className="body-copy mt-1.5 text-ink-soft">Edit hero text, the founder quote, about, impact numbers, and more.</p>
        </Link>
